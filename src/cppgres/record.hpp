...
struct tuple_descriptor {
   ...
   *
   * @param tupdesc existing attribtue
  ...
  tuple_descriptor(tuple_descriptor &other)
      : tupdesc(ffi_guard{::CreateTupleDescCopy}(other.tupdesc)), blessed(other.blessed) {}

  /**
   * @brief Move constructor
   */
  tuple_descriptor(tuple_descriptor &&other)
      : tupdesc(std::move(other.tupdesc)), blessed(other.blessed) {}
  ...
  tuple_descriptor &operator=(tuple_descriptor &other) {
    tupdesc = ffi_guard{::CreateTupleDescCopy}(other.tupdesc);
...
struct record {
  ...
  record(tuple_descriptor &tupdesc, Iter begin, Iter end)
      : tupdesc(tupdesc), tuple([&]() {
          ...
          for (auto it = begin; it != end; ++it) {
            ...
            values.push_back(nd.is_null() ? ::Datum(0) : it);
   ...
   */
  tuple_descriptor tuple_descriptor() const { return tupdesc; }
